...
async function getAllUsers(){
 ...
 userContainer.innerHTML +=
        ...
        <button  class ="btn1"onclick="editsUser(${user.id})"> <i class="fa fa-edit"></i></button>
        <button  class ="btn1" onclick="deleteUser(${user.id})"><i class='fa fa-trash'></i></button>
        ...
        <button  class ="btn1" onclick="saveUser(${user.id})">save</button>
        </div>
        </div>
        </div>`
       )
